...
const AttachCarUserForm: React.FC<AttachPointFormProps> = ({ isOpen, setIsOpen, carId }) => {
    ...
    const confirmForm = (values: any) =>{
        dispatch(attachCar({c_id: carId, u_id:values.user_id}))
        setIsOpen(false)
    }
...
export default AttachCarUserForm