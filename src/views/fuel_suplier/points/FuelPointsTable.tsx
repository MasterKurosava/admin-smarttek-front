...
import DeleteFuelPointForm from './DeleteFuelPointForm'
import СreateFuelPointForm from './СreateFuelPointForm'
...
const FuelPointsTable = () => {
    ...
    const [updatingPoint, setUpdatingPoint] = useState(0)
        ...
        () => [
            ...
            { 
                ...
                cell: (row: any) => {
                    ...
                    return <Button size="sm" variant="twoTone" color="blue-600" onClick={()=>onUpdatePoint(row.id)}>Изменить</Button>
                }
            },
            { 
                header: '', 
    ...
    return (
        <>
            ...
            <СreateFuelPointForm isOpen={addModal} setIsOpen={setAddModal}/>
            <UpdateFuelPointForm isOpen={updateModal} setIsOpen={setUpdateModal} fuelPointId={updatingPoint}/>
            <DeleteFuelPointForm isOpen={deleteModal} setIsOpen={setDeleteModal} currentPoint={currentPoint}/>
        </>
    )
}
