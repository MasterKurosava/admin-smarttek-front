...
import { createFuelPoint } from '@/store/slices/fuel_suplier'
...
const UpdateFuelPointForm: React.FC<AddPointFormProps> = ({ isOpen, setIsOpen }) => {
    ...
    const confirmForm = (values: FuellingPoint) =>{
        ...
        dispatch(createFuelPoint(values))
        setIsOpen(false)
    }
        ...
        <div>
            ...
            >
                <div className="px-6 pb-6">
                    <h5 className="mb-4">Обновление заправки</h5>
                    <Formik
                    initialValues={{
                        long: 0,
                        lat: 0,
...
export default UpdateFuelPointForm