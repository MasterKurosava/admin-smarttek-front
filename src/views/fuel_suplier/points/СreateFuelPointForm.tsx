...
import { createFuelPoint, updateFuelPoint } from '@/store/slices/fuel_suplier'
...
const СreateFuelPointForm: React.FC<UpdatePointFormProps> = ({ isOpen, setIsOpen }) => {
    ...
    const confirmForm = (values: FuellingPoint) =>{
        ...
        dispatch(updateFuelPoint(values))
        setIsOpen(false)
    }
...
export default СreateFuelPointForm